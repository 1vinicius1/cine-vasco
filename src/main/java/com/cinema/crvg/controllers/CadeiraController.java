...
public class CadeiraController {
    ...
    @PostMapping
    public ResponseEntity<CadeiraDTO> criar(@RequestBody CadeiraDTO cadeiraDTO) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<CadeiraDTO> atualizar(@PathVariable Long id, @RequestBody CadeiraDTO cadeiraDTO) {
